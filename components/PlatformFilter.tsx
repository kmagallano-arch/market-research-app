...
export const PLATFORMS: Record<string, { label: string; color: string; markets: string[] }> = {
  all:      { label: 'All',         color: '#64748B', markets: [] },
  ...
  elkjop:   { label: 'Elkjop',      color: '#003087', markets: ['NO'] },
...
export default function PlatformFilter({ value, onChange, market }: Props) {
  ...
  return (
    <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap', alignItems: 'center' }}>
      <span style={{ fontSize: 11, fontWeight: 600, color: '#94A3B8', textTransform: 'uppercase', letterSpacing: '0.5px', marginRight: 2, fontFamily: 'Geist, sans-serif' }}>Platform</span>
      {available.map(([key, p]) => {
