      ...
      <main style={{flex:1,padding:'28px 32px',overflow:'auto'}}>
        ...
        <div style={{display:'flex',gap:10,marginBottom:14,alignItems:'center'}}>
          ...
          <button
            ...
            style={{padding:'10px 22px',background:state==='streaming'?'#9CA3AF':'#2E6FFF',color:'white',border:'none',borderRadius:10,fontSize:14,fontWeight:600,cursor:state==='streaming'?'not-allowed':'pointer'}}
          >
        ...
        {state==='streaming' && (
          <div style={{marginBottom:20}}>
            <div style={{display:'flex',alignItems:'center',gap:10,marginBottom:12,padding:'14px 18px',background:'white',borderRadius:12,border:'1px solid #E8E9EF'}}>
              ...
              <span style={{fontSize:14,color:'#6B7280'}}>Scoring <b style={{color:'#1A1D2E'}}>{product || input}</b> in {m.label}...</span>
            ...
            <div style={{display:'flex',flexDirection:'column',gap:12}}>
              ...
              <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:12}}>
                ...
                <div className="card" style={{padding:'18px 20px'}}>
                  ...
                  {data.suggestedPrice && <div style={{marginTop:10,padding:'8px 12px',background:'rgba(46,111,255,0.08)',borderRadius:8,fontSize:13,color:'#2E6FFF'}}>💰 Suggested: <b>{data.suggestedPrice}</b> · MOQ: <b>{data.suggestedMOQ} units</b></div>}
                </div>
              </div>
            </div>
          </div>
