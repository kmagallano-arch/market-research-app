    ...
    <div style={{ display:'flex', minHeight:'100vh', background:'#F2F3F7' }}>
      ...
      <main style={{ flex:1, padding:'28px 32px', overflow:'auto' }}>
        ...
        <div style={{ display:'flex', gap:10, marginBottom:20, alignItems:'center', flexWrap:'wrap' }}>
          ...
          {loading && <div style={{ display:'flex', alignItems:'center', gap:6, fontSize:12, color:'#9CA3AF' }}><div style={{ width:12, height:12, borderRadius:'50%', border:'2px solid #E8E9EF', borderTopColor:m.color, animation:'spin 0.8s linear infinite' }}/>Scanning...</div>}
        </div>
            ...
            return (
              <div key={i} className="card" style={{ padding:'18px 20px' }}>
                ...
                <div style={{ display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:6, marginBottom:12 }}>
                  {[{v:p.searchGrowth,l:'Search',c:'#00C48C'},{v:p.conversionRate,l:'Conv.',c:'#2E6FFF'},{v:p.avgPrice,l:'Price',c:'#FFB830'}].map((s,j)=>(
