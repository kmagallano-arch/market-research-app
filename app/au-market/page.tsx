...
const MARKET_NAME = 'Australia'
const MARKET_FLAG = '🇦🇺'
const MARKET_COLOR = '#0EA5E9'
const MARKET_PLATFORMS = 'Amazon AU, eBay AU, Catch.com'
...
export default function AustraliaMarketPage() {
  ...
  useEffect(() => {
    fetch('/api/au-market').then(r=>r.json()).then(j=>{setData(j.data); setLoading(false)})
  }, [])
