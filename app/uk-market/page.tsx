...
const MARKET_CODE = 'UK'
const MARKET_NAME = 'UK'
const MARKET_FLAG = '🇬🇧'
const MARKET_COLOR = '#8B5CF6'
const MARKET_PLATFORMS = 'Amazon UK, eBay UK, Argos'
...
export default function UKMarketPage() {
  ...
  useEffect(() => {
    fetch('/api/uk-market').then(r=>r.json()).then(j=>{setData(j.data); setLoading(false)})
  }, [])
