...
const MARKET_NAME = 'Germany'
const MARKET_FLAG = '🇩🇪'
const MARKET_COLOR = '#FFB830'
const MARKET_PLATFORMS = 'Amazon DE, Otto, Kaufland'
...
export default function GermanyMarketPage() {
  ...
  useEffect(() => {
    fetch('/api/de-market').then(r=>r.json()).then(j=>{setData(j.data); setLoading(false)})
  }, [])
