...
const MARKET_CODE = 'BE'
const MARKET_NAME = 'Belgium'
const MARKET_FLAG = '🇧🇪'
const MARKET_COLOR = '#6366F1'
const MARKET_PLATFORMS = 'Bol.com, Amazon BE, Fnac'

export default function BelgiumMarketPage() {
  const [data, setData] = useState<any>(null)
  const [loading, setLoading] = useState(true)
  const [platform, setPlatform] = useState<PlatformKey>('all')

  useEffect(() => {
    fetch('/api/be-market').then(r=>r.json()).then(j=>{setData(j.data); setLoading(false)})
  }, [])
