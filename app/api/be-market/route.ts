...
export async function GET(req: NextRequest) {
  try {
    const data = await askOpenAIJSON(`You are a Belgium e-commerce market expert. Generate realistic data for Bol.com, Amazon BE, Fnac.
...
6 categories, 16 products, focus on electronics, home, food tech, smart home, prices in €10-€120, Belgium consumer context.`)
