...
const MARKET_NAME = 'France'
const MARKET_FLAG = '🇫🇷'
const MARKET_COLOR = '#E30613'
const MARKET_PLATFORMS = 'Amazon FR, Cdiscount, Fnac'

export default function FranceMarketPage() {
  const [data, setData] = useState<any>(null)
  const [loading, setLoading] = useState(true)
  const [platform, setPlatform] = useState<PlatformKey>('all')

  useEffect(() => {
    fetch('/api/fr-market').then(r=>r.json()).then(j=>{setData(j.data); setLoading(false)})
  }, [])
