...
const MARKET_NAME = 'Netherlands'
const MARKET_FLAG = '🇳🇱'
const MARKET_COLOR = '#00C48C'
const MARKET_PLATFORMS = 'Bol.com, Amazon NL, Coolblue'
...
export default function NetherlandsMarketPage() {
  ...
  useEffect(() => {
    fetch('/api/nl-market').then(r=>r.json()).then(j=>{setData(j.data); setLoading(false)})
  }, [])
